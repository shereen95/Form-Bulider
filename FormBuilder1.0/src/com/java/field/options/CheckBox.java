...
public class CheckBox extends Field {
	...
	public void addField(Form form) {
		String str = "<div onclick='app.changeTab(\"" + getId() + "\")' style='" + this.getWidth() + "margin: 0px; " + this.fieldPadding() + "'><label>" + this.getLabel() + "</label> <br/>" + this.getCheckList() + "<br>" + this.getFriendlyHint() + "</div>";
		System.out.println(this.getCheckList());
		form.append(str);
		super.addField(form);
	}
